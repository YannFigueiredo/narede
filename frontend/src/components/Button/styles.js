    ...
    return(
      variant === "tab" ? "#FFF" : 
        variant === "blue" ? theme.colors.blue["100"] : 
          variant === "gray" ? theme.colors.gray["100"] : "transparent"
    );
  }};
  transition: all linear .3s;
  padding: ${({theme}) => theme.spacing.padding.very_small};
  color: ${({theme}) => theme.colors.blue["900"]};
  text-transform: ${({variant}) => variant === "tab" ? "uppercase" : "normal"};
  font-weight: 700;
  ...
  &:hover {
    ...
    return(
      variant === "tab" ? theme.colors.blue["100"] : 
        variant === "blue" ? theme.colors.gray["100"] : 
          variant === "gray" ? theme.colors.blue["100"] : "transparent"
    );
  }};
  }
`;